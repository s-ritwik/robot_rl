...
def parse_g1_log(
    file_path: str, config_path: str, fields_path: str
...
def parse_malformed_csv(file_path: str, fields_path: str, num_obs: int, num_actions: int):
    ...
    for line in open(file_path):
        ...
        field_map = {column_order[1]: quoted_data, column_order[2]: trailing_data}
...
def plot_observation_and_action(
    timestamps: np.ndarray,
    obs: np.ndarray,
    acts: np.ndarray,
    obs_labels: list = None,
    act_labels: list = None,
    indices: dict = None,
    obs_keywords: list = None,
):
